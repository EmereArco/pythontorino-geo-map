...
var stop_turin_9 = L.geoJSON(bus_stops, {
    pointToLayer: function (feature, latlng) {
        // Use the custom icon for each point based on routes
		if (feature.properties["bus lines"] === '9' || feature.properties["bus lines"] === '33, 9' ) {
...
var stop_turin_33 = L.geoJSON(bus_stops, {
    pointToLayer: function (feature, latlng) {
        // Use the custom icon for each point based on routes
		if (feature.properties["bus lines"] === '33' || feature.properties["bus lines"] === '33, 9' ) {
...
var overlayMaps = {
    "fermate linea 9": stop_turin_9,
	"fermate linea 33": stop_turin_33,
	"fermate": stop_turin,
};
